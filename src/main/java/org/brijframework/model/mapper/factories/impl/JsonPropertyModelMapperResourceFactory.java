...
public class JsonPropertyModelMapperResourceFactory extends AbstractModuleFactory<String,PropertyModelMapperResource> implements ModelMapperFactory<String,PropertyModelMapperResource> {
	...
	protected JsonPropertyModelMapperResourceFactory() {
	}

	protected static JsonPropertyModelMapperResourceFactory factory;

	@SingletonFactory
	public static JsonPropertyModelMapperResourceFactory getFactory() {
		if (factory == null) {
			factory = new JsonPropertyModelMapperResourceFactory();
		}
		return factory;
	}

	@Override
	public JsonPropertyModelMapperResourceFactory loadFactory() {
